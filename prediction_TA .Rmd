...
AIC(lm.all, lm.nodict, lm.onlyfactors, lm.onlyemotions, lm.onlywords, lm.bigrams, lm.words_bigrams, lm.posneg, lm.fe_step)
```
...
for (m in list(lm.all, lm.nodict, lm.onlyfactors, lm.onlyemotions, lm.onlywords, lm.bigrams, lm.words_bigrams, lm.posneg))
{
...
print("lm.all, lm.nodict, lm.onlyfactors, lm.onlyemotions, lm.onlywords, lm.bigrams, lm.words_bigrams, lm.posneg")
```
...
f <- "as.factor(rating) ~ Nr_of_words + factor1 + factor3 + factor6 + 
    factor7 + factor8 + factor9 + factor10 + factor13 + factor16 + 
    factor19 + fall + anticipation + disgust + joy + trust + 
    factor20 + fit + size + wear + love + color + fabric + nice + 
    flatter + jean + feel + style + purchas + line + positive + 
